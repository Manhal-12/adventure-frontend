...
function CustomerUpdateForm() {
  ...
  function getAll() {
    axios
      .get(`https://adventure-backend-4.onrender.com/read/customer/${params.id}`)
      .then((res) => {
  ...
  axios.put(`https://adventure-backend-4.onrender.com/update/customer/${params.id}`,{
  ...
  function handleUpdate(e) {
    ...
    axios
      .put(`https://adventure-backend-4.onrender.com/update/customer/${params.id}`, {
        customerName,
        gmail,
        phone,
        address,
