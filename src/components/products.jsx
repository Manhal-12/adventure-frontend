...
function productTable() {
  ...
  function showData() {
    axios.post(`https://adventure-backend-4.onrender.com/read/product`)
  ...
  const searchData  = (id) => {
    ...
    if(key){
      axios.get(`https://adventure-backend-4.onrender.com/search/product/${key}`).then((res) => {
  ...
  const handleDelete = (id) => {
    axios.delete(`https://adventure-backend-4.onrender.com/delete/product/${id}`).then(() => {
